...
with st.sidebar:
    ...
    if st.button("Guardar Meta"):
        # Más adelante aquí pondremos el requests.post() para enviar los datos a FastAPI
...
if st.button("🔄 Actualizar Datos"):
    try:
        ...
        # Asegúrate de que el puerto sea el correcto (normalmente 8000)
        ...
        if respuesta.status_code == 200:
            ...
            # Como por ahora el backend solo devuelve un {"status": "..."}, lo metemos en una lista
